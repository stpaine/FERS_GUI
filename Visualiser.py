#-- Visualiser.py as part of Plugin
...
class Ui_MainWindow(QtGui.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_3.addWidget(self.FERS_Input_2, 0, 0, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.line_6, 3, 0, 2, 2)
        ...
        self.gridLayout_3.addWidget(self.T_Pulse_name_label_3, 4, 1, 1, 1)
        ...
        self.gridLayout_3.addLayout(self.horizontalLayout_7, 9, 1, 1, 1)
        ...
        self.gridLayout_3.addLayout(self.horizontalLayout_21, 10, 0, 1, 2)
        self.line_5 = QtGui.QFrame(self.centralwidget)
        self.line_5.setFrameShape(QtGui.QFrame.HLine)
        self.line_5.setFrameShadow(QtGui.QFrame.Sunken)
        self.line_5.setObjectName(_fromUtf8("line_5"))
        self.gridLayout_3.addWidget(self.line_5, 11, 0, 1, 2)
        ...
        self.gridLayout_3.addLayout(self.gridLayout, 12, 0, 1, 2)
        self.line = QtGui.QFrame(self.centralwidget)
        self.line.setFrameShape(QtGui.QFrame.HLine)
        self.line.setFrameShadow(QtGui.QFrame.Sunken)
        self.line.setObjectName(_fromUtf8("line"))
        self.gridLayout_3.addWidget(self.line, 13, 0, 1, 2)
        ...
        self.gridLayout_3.addLayout(self.gridLayout_2, 14, 0, 1, 2)
        self.line_2 = QtGui.QFrame(self.centralwidget)
        self.line_2.setFrameShape(QtGui.QFrame.HLine)
        self.line_2.setFrameShadow(QtGui.QFrame.Sunken)
        self.line_2.setObjectName(_fromUtf8("line_2"))
        self.gridLayout_3.addWidget(self.line_2, 15, 0, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.View_btn, 16, 0, 1, 2)
        self.line_3 = QtGui.QFrame(self.centralwidget)
        self.line_3.setFrameShape(QtGui.QFrame.HLine)
        self.line_3.setFrameShadow(QtGui.QFrame.Sunken)
        self.line_3.setObjectName(_fromUtf8("line_3"))
        self.gridLayout_3.addWidget(self.line_3, 17, 0, 1, 2)
        ...
        self.gridLayout_3.addLayout(self.horizontalLayout_16, 18, 0, 1, 2)
        self.line_4 = QtGui.QFrame(self.centralwidget)
        self.line_4.setFrameShape(QtGui.QFrame.HLine)
        self.line_4.setFrameShadow(QtGui.QFrame.Sunken)
        self.line_4.setObjectName(_fromUtf8("line_4"))
        self.gridLayout_3.addWidget(self.line_4, 19, 0, 1, 2)
        ...
        self.gridLayout_3.addWidget(self.show, 20, 0, 1, 2)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(_translate("MainWindow", "Radar Visualiser", None))
        self.FERS_Input_2.setText(_translate("MainWindow", "Radar Visualiser", None))
        ...
        self.rcs.setPlaceholderText(_translate("MainWindow", "<Sample Value>", None))
        self.pushButton_2.setText(_translate("MainWindow", "Clear", None))
        self.T_Pulse_name_label_5.setText(_translate("MainWindow", "X Value (Longitude):", None))
        self.x.setPlaceholderText(_translate("MainWindow", "< [-180 ; 180] >", None))
        self.pushButton_3.setText(_translate("MainWindow", "Clear", None))
        self.T_Pulse_name_label_6.setText(_translate("MainWindow", "Y Value (Latitude):", None))
        self.y.setPlaceholderText(_translate("MainWindow", "< [-90 ; 90] >", None))
        self.pushButton_4.setText(_translate("MainWindow", "Clear", None))
        self.T_Pulse_name_label_7.setText(_translate("MainWindow", "Altitude", None))
        self.alt.setPlaceholderText(_translate("MainWindow", "<Sample Value (km)>", None))
        ...
        self.T_Pulse_name_label_12.setText(_translate("MainWindow", "Longitude:", None))
        self.tx_x.setPlaceholderText(_translate("MainWindow", "< Range [-180 ; 180] >", None))
        self.pushButton_9.setText(_translate("MainWindow", "Clear", None))
        self.T_Pulse_name_label_17.setText(_translate("MainWindow", "Latitude", None))
        self.tx_y.setPlaceholderText(_translate("MainWindow", "< Range [-90 ; 90 ] >", None))
        ...
        self.T_Pulse_name_label_9.setText(_translate("MainWindow", "Longitude:", None))
        self.rx_x.setPlaceholderText(_translate("MainWindow", "< Range [-180 ; 180] >", None))
        self.pushButton_7.setText(_translate("MainWindow", "Clear", None))
        self.T_Pulse_name_label_10.setText(_translate("MainWindow", "Latitude", None))
        self.rx_y.setPlaceholderText(_translate("MainWindow", "< Range [-90 ; 90 ] >", None))
        ...
        self.T_Pulse_name_label_13.setText(_translate("MainWindow", "and", None))
        self.T_Pulse_name_label_14.setText(_translate("MainWindow", "in kiometers", None))
    ...
    ##generates 3d plot in XYZ all in metres  
    def generatePlot(self):
        ...
        for i in range(len(tx_val)):
            ax.plot([tx_val[i],ox_val[0]],[ty_val[i],oy_val[0]],[tz_val[i],oz_val[0]], c = 'r')
    ...
    def setTxNum(self): 
        ...
        if (int(val)>len(a)):
            ...
            for i in range(dif):
                global num_tx
                a.append(num_tx)
                lol = int(num_tx) +1## increment num_tx
                num_tx=str(lol) 
                tx.insert(i+dif, '')
                ty.insert(i+dif, '')
                tz.insert(i+dif, '')
            ...
            while int(val)<len(a):
                lol = int(num_tx) -1## decrement num_tx
                num_tx = str(lol)
                a.pop(len(a)-1)
                tx.pop(len(a))
                ty.pop(len(a))
    ...
    def setRxNum(self):
        ...
        if (int(val)>len(b)):
            ...
            for i in range(dif):
                ...
                global num_rx
                b.append(num_rx)
                lol = int(num_rx) +1 ## increment num_rx
                num_rx=str(lol) 
            ...
            wiz = len(b)-int(val)
            for i in range(wiz):
                lol = int(num_rx) -1## decrement num_rx
                num_rx = str(lol)
                b.pop(len(b)-1)
                rx.pop(len(b))
                ry.pop(len(b))
    ...
    def addReceiver(self):
        ...
        if (float(longi)>=-180 and float(longi)<180):
            rx[int(num)]=longi          ##sets rx x coord
            if (float(lat)>=-90 and float(lat)<90):
                ry[int(num)]=lat            ##sets rx y coord
            else:
                print '--Please enter correct latitude--'
                return
        else:
            print '--Please enter correct longitude--'
            return
        rz[int(num)] = 0            ##sets rx z coord        
    ...
    def addTransmitter(self):
        ...
        if (float(longi)>=-180 and float(longi)<180):
            tx[int(num)]=longi          ##sets tx x coord
            if (float(lat)>=-90 and float(lat)<90):
                ty[int(num)]=lat            ##sets tx y coord
            else:
                print '--Please enter correct longitude--'
                return
        else:
    ...
    def addTarget(self):
        ...
        if (float(longit)>=-180 and float(longit)<=180):
            oy[0]=longit
            if (float(latt)>=-90 and float(latt)<=90):
                ox[0]=latt
                oz[0]=alti
            else:
                print '--Please enter correct latitude--'
