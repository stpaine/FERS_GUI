# -- ReceiverPlat.py as part of FERS XML File I/O as part of FERS Plugin
...
class Ui_Receiver(QtGui.QMainWindow):
    ...
    def setupUi(self, Receiver):
        ...
        self._2.addWidget(self.propcheck, 8, 1, 1, 1)
        ...
        self._2.addWidget(self.T_Pulse_Carrier_label_4, 11, 0, 1, 1)
        ...
        self._2.addWidget(self.Rx_Antenna_name_input, 2, 1, 1, 1)
        ...
        self._2.addWidget(self.T_Pulse_carrier_clear, 6, 3, 1, 1)
        ...
        self._2.addWidget(self.T_Pulse_power_clear, 5, 3, 1, 1)
        ...
        self._2.addWidget(self.T_Pulse_filename_clear_4, 3, 3, 1, 1)
        ...
        self._2.addWidget(self.T_Pulse_name_label_3, 2, 0, 1, 1)
        ...
        self._2.addWidget(self.ignorecheck, 9, 1, 1, 1)
        ...
        self._2.addWidget(self.T_Pulse_carrier_clear_2, 7, 3, 1, 1)
        ...
        self._2.addWidget(self.T_Pulse_name_clear, 4, 3, 1, 1)
        ...
        self._2.addWidget(self.T_Pulse_Carrier_label_3, 8, 0, 1, 1)
        self.label_2 = QtGui.QLabel(self.centralwidget)
        self.label_2.setObjectName(_fromUtf8("label_2"))
        self._2.addWidget(self.label_2, 4, 2, 1, 1)
        ...
        self._2.addWidget(self.T_Pulse_Carrier_label, 6, 0, 1, 1)
        ...
        self._2.addWidget(self.T_Pulse_carrier_clear_3, 11, 3, 1, 1)
        ...
        self._2.addWidget(self.T_Pulse_filename_clear_3, 2, 3, 1, 1)
        ...
        self._2.addWidget(self.Rx_Timing_name_input, 3, 1, 1, 1)
        ...
        self._2.addWidget(self.Rx_Window_skip_input, 4, 1, 1, 1)
        ...
        self._2.addWidget(self.Rx_window_leng_input, 5, 1, 1, 1)
    ...
    def retranslateUi(self, Receiver):
        ...
        self.T_Pulse_name_label.setText(_translate("Receiver", "Receiver Name", None))
        ...
        self.T_Pulse_name_label_2.setText(_translate("Receiver", "Platform  Name", None))
    ...
    def callAppend(self):
        ...
        appendRxToPlatform(filename, plat_name, name, antenna_name, clock_name, nd_bool, noploss_bool, skip_time, receiver_window_length, pulse_rf, receiver_temp)
        print'--Receiver added to platorm--'        
